\subsection{Main Game Loop}
	...
	\textbf{Food Collision Detection} \newline
		Food collision detection is handled using Axis-Aligned Bounding Box Collision Detection \cite{CollisionDetection}, exactly the same approach used for collision detection of the snake. See section \ref{section:CollisionDetection} for a description of the algorithm and why we chose to use it.
