...
To communicate easily with the display, we made a SPI-driver that could initialize SPI communication and send instructions and data from the ATMEGA to a SPI-bus connected to the display. The class diagram of this SPI driver can be seen in figure \ref{SpiDriverClassDiagram}.
