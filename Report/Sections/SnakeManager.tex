...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|}
		...
		SnakeHitSelf & \begin{tabular}[c]{@{}c@{}}This will is used by other components to figure out if the snake has\\ hit itself. A return value of 1 indicates collision, and a value of\\ 0 indicates no collision.\end{tabular} \\ \hline
