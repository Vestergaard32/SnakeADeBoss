...
\section{System Description}
	...
	\subsection{Block Definition Diagram}
		...
		\begin{table}[H]
			...
			\begin{tabular}{|l|l|}
				...
				Membrane Keyboard & \begin{tabular}[c]{@{}l@{}}A 4x4 membrane keypad. The user interacts with the system \\ via this component. The result of interactions with this com-\\ ponent is displayed on Nokia 5110 Display.\end{tabular} \\ \hline
	...
	\label{section:InternalBlockDiagram}
		...
		Figure \ref{fig:ibd} shows the interal block diagram for SnakeADeBoss. This diagram describes the signals sent between the system's blocks. The following tabel describes the signals in the diagram.
		\begin{figure}[H]
		...
		\begin{table}[H]
			...
			\begin{tabular}{|l|l|l|l|}
				\hline
				\multicolumn{4}{|c|}{\textbf{Membrane Keypad}} \\ \hline
				Description & Signal & Direction & Signal Description \\ \hline
			...
			\end{tabular}
			\caption{A description of the input and output signals of the membrane keypad.}
